...
class FirebaseUserRepository implements UserRepository {
    ...
    if (result.exists) {
      ...
      if (updateResult.exists) {
        ...
        if (updateUser.balance == balance) {
          ...
          return const Result.failed('Failed to update user balancce');
        }
      } else {
        return const Result.failed('Failed to retrive updated user data ');
      }
    } else {
      return const Result.failed('user not found');
    }
  ...
  Future uploadProfilePicture(
    ...
    try {
      ...
      return const Result.failed('failed to upload profile image');
    }
  }
}
